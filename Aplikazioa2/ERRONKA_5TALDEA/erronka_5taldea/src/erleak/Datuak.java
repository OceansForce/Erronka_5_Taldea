...
public class Datuak {// datu basearekin konexioa ahalbidetzeko datuak definitu.
    private static final String key = "FooBar1234567890"; // 128 bit
...
//Aldagaiak definitu.
    ...
    public static void izena_jarri(String identifikatzailea){// identifikatzaile bakoitzarekin sozioaren datu guztiak emnago ditu.
    ...
    public static boolean identifikatzailea_ondo(String identifikatzailea){// identifikatzaile bakoitzarekin sozioaren datu guztiak emnago ditu.
        ArrayList<Sozioak> sozio_lista= sozio_ArrayList();// sozioen arraylista.
        for (Sozioak s: sozio_lista) {// sozio bakoitzeko.
            String izen_abizen = s.getSozio_izena()+" "+s.getSozio_abizena();// ArrayList-etik izena eta abizen artu eta batu, hau identifikatzaile bat da eta honekin konparatzeko.
            if ((izen_abizen).equals(identifikatzailea)){// sortukako testuak datu baseko izen eta abizenekin koinziditzen badu.
...
// identifikatzaile mota 4 izango da.
    ...
    public static String pazaitza_jarri(String identifikatzaile){// identifikatzaile bakoitzeko pasahitza lortu.
    ...
    public static String[][] ezti_bilatzailea(String ezti_izena){
        try {
    ...
    public static String[][] sozio_Array_bilatzailea(String izena){//Array bat bueltatuko duen funtzioa.
    ...
    public static String[][] besteak_bilatu(String produktu_izena){// beste batzuk taula buelatuko duen funtzioa.
        try {
            konexioa();// konexioa egin datu basearekin.
            Statement stmt= con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);// datu baseko kontsulta sortu.
    ...
    public static String[][] materiala_bilatu(String material_izena){// materiak taula.
        try {
            konexioa();// konexioa sortu datu basearekin.
            Statement stmt= con.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY);// kontsulta sortu.
